...
class SpriteHelper {
    public:
        ...
        inline static CCSprite* getMostEXPIcon(GJUserScore* score) {
            ...
            if (max({starEXP, moonEXP, diamondEXP, secretCoinEXP, userCoinEXP, demonEXP, cpEXP}) == starEXP)
                return CCSprite::createWithSpriteFrameName("GJ_starsIcon_001.png");
            if (max({starEXP, moonEXP, diamondEXP, secretCoinEXP, userCoinEXP, demonEXP, cpEXP}) == moonEXP)
                return CCSprite::createWithSpriteFrameName("GJ_moonsIcon_001.png");
            if (max({starEXP, moonEXP, diamondEXP, secretCoinEXP, userCoinEXP, demonEXP, cpEXP}) == diamondEXP)
                return CCSprite::createWithSpriteFrameName("GJ_diamondsIcon_001.png");
            if (max({starEXP, moonEXP, diamondEXP, secretCoinEXP, userCoinEXP, demonEXP, cpEXP}) == secretCoinEXP)
                return CCSprite::createWithSpriteFrameName("GJ_coinsIcon_001.png");
            if (max({starEXP, moonEXP, diamondEXP, secretCoinEXP, userCoinEXP, demonEXP, cpEXP}) == userCoinEXP)
                return CCSprite::createWithSpriteFrameName("GJ_coinsIcon2_001.png");
            if (max({starEXP, moonEXP, diamondEXP, secretCoinEXP, userCoinEXP, demonEXP, cpEXP}) == demonEXP)
                return CCSprite::createWithSpriteFrameName("GJ_demonIcon_001.png");
            if (max({starEXP, moonEXP, diamondEXP, secretCoinEXP, userCoinEXP, demonEXP, cpEXP}) == cpEXP)
